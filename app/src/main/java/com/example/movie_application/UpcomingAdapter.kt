...
class UpcomingAdapter(val value: List<UpcomingHolder>): RecyclerView.Adapter<UpcomingAdapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(provider: ViewGroup, displatFormat: Int): viewHolder {
        ...
        val display: View = LayoutInflater.from(provider.context).inflate(R.layout.activity_upcoming_new_card_view, provider, false)
